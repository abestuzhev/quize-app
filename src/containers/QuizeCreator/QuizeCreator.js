...
export default class QuizeCreator extends Component {
    ...
    createQuizeHandler = async (event)=> {
        ...
        try {
            await axios.post('https://quize-dcede.firebaseio.com/quize.json', this.state.quize);
